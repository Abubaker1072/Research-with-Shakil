...
class SiteSettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'stat_learners', 'value' => '21550', 'group' => 'stats', 'type' => 'number'],
            ['key' => 'stat_reviews', 'value' => '1865', 'group' => 'stats', 'type' => 'number'],
            ...
            ['key' => 'stat_ssci_papers', 'value' => '53+', 'group' => 'stats', 'type' => 'string'],
